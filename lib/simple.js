...
function makeRequestWithOptions(fetch, url, defaultOptions, fetchOptions) {
  var options = merge(defaultOptions, fetchOptions);
...
function addMetaToPayload(payload, httpResponse) {
  var responseMeta = getResponseMeta(httpResponse);
  var meta = merge(payload.meta, responseMeta);
...
module.exports = {
  ...
  remove: curry(remove)(fetch, {}),
  put: curry(put)(fetch, {}),
  addMetaToPayload: addMetaToPayload
};