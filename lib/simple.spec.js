...
var _require$options = require('./simple').options,
    post = _require$options.post,
    get = _require$options.get,
    put = _require$options.put,
    remove = _require$options.remove;

var _require = require('./simple'),
    addMetaToPayload = _require.addMetaToPayload;

var _require2 = require('./test/server'),
...
describe('simple protocol', function () {
  ...
  config.forEach(function (_ref) {
    var fn = _ref.fn,
        method = _ref.method,
        supportsPayloads = _ref.supportsPayloads;
    ...
    var validateRequest = function validateRequest(getRequestData) {
      var _getRequestData = getRequestData(),
          body = _getRequestData.body,
          headers = _getRequestData.headers;
...
describe('addMetaToPayload()', function () {
  it('should merge meta', function () {
    var payload = { foo: 'bar', meta: { bar: 'baz' } };
    var httpResponse = { status: 200, statusText: 'good', headers: { _headers: {} } };
    var result = addMetaToPayload(payload, httpResponse);
